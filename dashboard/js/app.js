...
const App = (() => {
  ...
  const PAGES = {
    ...
    heatmap:     { title: 'Market Heatmap',       group: 'market',   icon: 'M4 5a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1v-4zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z' },
    defi:        { title: 'DeFi',                 group: 'market',   icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    derivatives: { title: 'Derivatives & Funding',group: 'market',   icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
    onchain:     { title: 'On-Chain Analytics',   group: 'analysis', icon: 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1' },
